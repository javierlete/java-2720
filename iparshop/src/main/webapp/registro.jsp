		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="password" name="password" value=""
					...
					id="password">
				<div class="invalid-feedback">Es obligatorio rellenar la contraseña y debe tener al menos un dígito, una letra minúscula, una letra mayúscula, un símbolo y debe ser de al menos 8 caracteres</div>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="direccion" value="${cliente.direccion}"
					...
					id="direccion">
				<div class="invalid-feedback">La dirección es obligatorio rellenarla</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="codigo-postal"
					...
					id="codigo-postal">
				<div class="invalid-feedback">Debes rellenar el código postal y deben ser 5 dígitos</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="nif" value="${cliente.nif}"
					...
					id="nif">
				<div class="invalid-feedback">Debes rellenar el NIF con el formato 12345678A ó X1234567B</div>
